...
//
//            HWPartition[] partitions = disk.getPartitions();//分区
//            if (partitions == null) {
...
//        Host host=new Host();
//        host.setMac(networkIFs[0].get.getMacaddr());
//
//        host.setIp(networkIFs[0].getIPv4addr().toString());
